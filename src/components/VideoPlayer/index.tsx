/**
 * 自定义播放器控制条样式
 * copy from 'react-native-video-controls/VideoPlayer.js'
*/
...
export default class VideoPlayer extends Component {
  ...
  renderTopControls() {
    ...
    return (
      <Animated.View
        ...
        <ImageBackground
          source={require('react-native-video-controls/assets/img/top-vignette.png')}
  ...
  renderBack() {
    return this.renderControl(
      <Image
        source={require('react-native-video-controls/assets/img/back.png')}
      ...
      <View style={styles.volume.container}>
        ...
        <View
          ...
          <Image
            ...
            source={require('react-native-video-controls/assets/img/volume.png')}
          />
        </View>
      </View>
    );
  ...
  renderFullscreen() {
    let source =
      this.state.isFullscreen === true
        ? require('react-native-video-controls/assets/img/shrink.png')
        : require('react-native-video-controls/assets/img/expand.png');
    return this.renderControl(
      <Image source={source} />,
      this.methods.toggleFullscreen,
    ...
    return (
      <Animated.View
        ...
        <ImageBackground
          ...
          style={[styles.controls.column, this.props.controlsWrapper]}
          imageStyle={[styles.controls.vignette]}>
          <SafeAreaView
            style={[styles.controls.row, styles.controls.bottomControlGroup, this.props.bottomControlGroupStyle]}>
            {playPauseControl}
            {this.renderTitle()}
            {timerControl}
          </SafeAreaView>
  ...
  renderSeekbar() {
    return (
      <View style={StyleSheet.flatten([styles.seekbar.container, this.props.seekbarWrapper])}>
        <View
        ...
        <View
          ...
          <View
            style={[
              ...
              {backgroundColor: this.props.seekBallColor || this.props.seekColor || '#FFF'},
            ]}
          />
        </View>
      </View>
  ...
  renderTimer() {
    return this.renderControl(
      ...
      StyleSheet.flatten([styles.controls.timer, {}]),
    );
  }
    ...
    if (this.state.loading) {
      return (
        <View style={styles.loader.container}>
          <Animated.Image
            source={require('react-native-video-controls/assets/img/loader-icon.png')}
            style={[
              styles.loader.icon,
              {
                transform: [
    ...
    if (this.state.error) {
      return (
        <View style={styles.error.container}>
          <Image
            source={require('react-native-video-controls/assets/img/error-icon.png')}
