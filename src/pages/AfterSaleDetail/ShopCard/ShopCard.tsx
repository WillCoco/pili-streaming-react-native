  ...
  return (
    <View style={styles.container}>
      ...
      <View style={styles.goodsInfo}>
        <Image source={{ uri: orderInfo.skuImg }} style={styles.goodsImg} />
        <View style={styles.goodsDetail}>
          <Text style={styles.goodsName} numberOfLines={2}>{orderInfo.goodsName}</Text>
          <View style={styles.goodsSku}>
            <Text style={styles.text}>{orderInfo.specJson}</Text>
            <Text style={[styles.text, { marginLeft: pxToDp(40) }]}>数量：</Text>
            <Text style={styles.text}>{orderInfo.goodsNum}</Text>
          </View>
