...
function Logion(props: any) {
  ...
  const [telNum, setTelNum] = useState('13073637801');
  const [verCode, setVerCode] = useState('9527');
  ...
  return (
    <ImageBackground
      ...
      <TouchableOpacity style={styles.weChatContent} onPress={loginWithWeChat}>
        <Image
          source={require('../../assets/login-image/wechat.png')}
