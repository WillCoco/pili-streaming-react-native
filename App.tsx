              ...
              <View style={{flex: 1}}>
                ...
                <NavigationContainer ref={navigationRef as any}>
                  <Stack.Navigator>
                    ...
                    />
                    <Stack.Screen
                      name="CreateLiveScreen"
                      component={CreateLive}
                      options={{headerShown: false}}
                    />
                    <Stack.Screen
                      name="CreateTeaserScreen"
                      component={CreateTeaser}
                      options={{headerShown: false}}
                    />
                    <Stack.Screen
                      name="LiveGoodsPicker"
                      component={LiveGoodsPicker}
                      options={{headerShown: false}}
                    />
                    <Stack.Screen
                      name="LiveGoodsManage"
                      component={LiveGoodsManage}
                      options={{headerShown: false}}
                    />
                    <Stack.Screen
                      name="LiveGoodsManageAgain"
                      component={LiveGoodsManage}
                      options={{headerShown: false}}
                    />
                    <Stack.Screen
                      name="AnorchLivingRoomScreen"
                      component={AnorchLivingRoom}
                      options={{headerShown: false, gestureEnabled: false}}
                    />
                    <Stack.Screen
                      name="AnchorTrailers"
                      component={AnchorTrailers}
                      options={{headerShown: false}}
                    />
                    <Stack.Screen
                      name="AnchorRecords"
                      component={AnchorRecords}
                      options={{headerShown: false}}
                    />
                    <Stack.Screen
                      name="LivesAnalyze"
                      component={LivesAnalyze}
                      options={{headerShown: false}}
                    />
                    <Stack.Screen
                      name="LivingGoodsWareHouse"
                      component={LivingGoodsWareHouse}
                      options={{headerShown: false}}
                    />
                    <Stack.Screen
                      name="AnchorShowcaseManage"
                      component={AnchorShowcaseManage}
                      options={{headerShown: false}}
                    />
                    <Stack.Screen
                      name="BeAgent"
                    ...
                    />
                    <Stack.Screen
                      name="BeAgentAgreement"
                      component={BeAgentAgreement}
                    />
                    <Stack.Screen
                      name="ShopAgreement"
                    ...
                    />
                    <Stack.Screen
                      name="ShopAddressManage"
                      component={ShopAddressManage}
                      options={{headerShown: false}}
                    />
                    <Stack.Screen
                      name="GoodsManage"
                    ...
                    <Stack.Screen
                      name="AnchroBill"
                      component={AnchroBill}
                      options={{headerShown: false}}
                    />
                    <Stack.Screen
                      name="ActivityWebView"
                      component={ActivityWebView}
                    />
                    ...
                    <Stack.Screen
                      ...
                      component={AnchorAgreement}
                      options={{headerShown: false}}
                    />
                    <Stack.Screen
                      name="AnchorLivingEnd"
                      component={AnchorLivingEndScreen}
                      options={{headerShown: false, gestureEnabled: false}}
                    />
                    <Stack.Screen
                      name="AudienceLivingEnd"
                      component={AudienceEndScreen}
                      options={{headerShown: false, gestureEnabled: false}}
                    />
                    <Stack.Screen
                      name="BankCardBag"
                      component={BankCardBag}
                      options={{headerShown: false}}
                    />
                    <Stack.Screen
                      name="AddBankCard"
                    ...
                    />
                    <Stack.Screen
                      name="LivePlatformStandard"
                      component={LivePlatformStandard}
                    />
                    <Stack.Screen
                      name="AnchorEntryAgreement"
                      component={AnchorEntryAgreement}
                    />
                  </Stack.Navigator>
                </NavigationContainer>
              </View>
